...
import {editModelType, getModelType} from "../../../redux/action/ModelType";


function EditModelType() {
    ...
    const loadModelType = async (modelTypeId) => {
        await dispatch(getModelType(modelTypeId)).then(resp => {
    ...
    const handleSubmitForm = async (values) => {
        await dispatch(editModelType(`${id}`, values)).then(resp => {
